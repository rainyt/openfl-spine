...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("ZYGameEngineHaxe", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("ZYGameEngineHaxe", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["packageName"] = "com.sample.zygameenginehaxe";
	...
	macro public static function getEntryPoint()
	{
		...
		switch (Context.follow(Context.getType("maplive.core.Maplive")))
		{
			case TInst(t, params):
				...
				if (hasMain)
				{
					return Context.parse("@:privateAccess maplive.core.Maplive.main()", Context.currentPos());
				}
				...
				{
					Context.fatalError("Main class \"maplive.core.Maplive\" has neither a static main nor a constructor.", Context.currentPos());
				}

			default:

				Context.fatalError("Main class \"maplive.core.Maplive\" isn't a class.", Context.currentPos());
		}
...
@:keep @:dox(hide) class DocumentClass extends maplive.core.Maplive {}
#else
class DocumentClass
{
