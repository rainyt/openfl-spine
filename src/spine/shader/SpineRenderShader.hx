...
class SpineRenderShader extends OpenFLGraphicsShader {
	...
	override function fragment() {
		...
		var rootColor:Vec3 = gl_FragColor.rgb * (1 - muldarkcolor.a) + (muldarkcolor.a) * (gl_FragColor.rgb + muldarkcolor.rgb * (1 - gl_FragColor.rgb));
		gl_FragColor.rgb = rootColor * mulcolor.rgb * gl_FragColor.a;
